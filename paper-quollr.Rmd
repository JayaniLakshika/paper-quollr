...
This paper presents the R package, `quollr`, which is useful for understanding how NLDR warps high-dimensional space and fits the data ([Figure 1](#fig-algo)).
...
```{r, eval=knitr::is_latex_output(), fig.cap="algorithm", fig.pos='H'}
...
```{r, eval=knitr::is_latex_output(), out.width="100%", fig.height=5, fig.width=25, fig.pos='H', fig.cap="Key steps for constructing the model on the UMAP layout: (a) NLDR data, (b) hexagon bins, (c) bin centroids, (d) triangulated centroids, and (e) lifting the model into high dimensions. The `Scurve` data is shown."}
