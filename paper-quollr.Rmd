...
1. Data preparation — functions such as `gen_scaled_data()` standardize the input, manage variable naming, and ensure consistent identifiers across high-dimensional and embedded datasets.
...
```{r, echo=TRUE, eval=knitr::is_html_output(), layout = "l-page"}
