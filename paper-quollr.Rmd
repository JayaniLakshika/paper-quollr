...
error_plot_scurve_hist1 + scurve_umap_plt_select1_lk2 + scurve_umap_plt_select1 +
  error_plot_scurve_hist2 + scurve_umap_plt_select2_lk2 + scurve_umap_plt_select1 +
  plot_layout(ncol = 3)
```
