...
algofig <- bscols(
  htmltools::div(
    ...
    htmltools::div(
      ...
      htmltools::div(style = 'margin: 0; padding: 0; margin-left: 60px; height: 300px;  text-align: left;', htmltools::h4("d"), scurve_umap_model_vis_n)
    )
  ),
  device = "xs"
)
...
error_plt <- ggplotly(error_plt, width = 200,
                      height = 200, tooltip = "none") |>
  style(unselected=list(marker=list(opacity=1))) |>
  highlight(on="plotly_selected", off="plotly_deselect") |>
  config(displayModeBar = FALSE)
...
nldr_plt <- ggplotly(nldr_plt, width = 200,
                     height = 200, tooltip = "none") |>
  style(unselected=list(marker=list(opacity=1))) |>
  highlight(on="plotly_selected", off="plotly_deselect") |>
  config(displayModeBar = FALSE)
