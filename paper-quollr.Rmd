...
# umap_limb_scaled_with_cluster <- umap_limb_scaled |>
#   mutate(cluster = umap_limb_scaled_with_cluster$cluster)

trimesh_removed_limb <- ggplot() + 
  geom_point(
    data = tsne_limb_scaled,
    aes(
      x = emb1,
      y = emb2
    ),
...
#   select(-type) |>
#   mutate(type = as.character(umap_limb_scaled_with_cluster$cluster))

df_model_data_limb_n <- bind_rows(df_b_limb, data_limb)
