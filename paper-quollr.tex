...
\midrule
\texttt{compute\_highd\_dist()} & 1.56ms & 2.38ms & 1.5\\
\texttt{calc\_2d\_dist\_cpp()} & 6.99us & 6.93us & 1.0\\
\texttt{gen\_hex\_coord\_cpp()} & 99.42us & 2.88ms & 29.0\\
\texttt{compute\_errors()} & 107.83us & 139.95us & 1.3\\
\bottomrule
\end{tabular}
\end{table}
