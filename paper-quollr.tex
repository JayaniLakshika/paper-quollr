...
\subsection{Compute hexagonal bin configurations}\label{compute-hexagonal-bin-configurations}}
...
\begin{figure}
\includegraphics[width=1\linewidth,height=1\textheight]{figures/hex_size_img} \caption{Hexagonal size parameter}\label{fig:hex-size-img}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth,height=1\textheight]{figures/spacing_img} \caption{Horizontal and vertical spacing parameters}\label{fig:spacing-img}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth,height=1\textheight]{figures/buffer_img} \caption{Buffer parameters}\label{fig:buffer-img}
\end{figure}

\hypertarget{number-of-bins-along-the-x-axis-b_1}{%
\subsubsection{\texorpdfstring{Number of bins along the x-axis (\(b_1\))}{Number of bins along the x-axis (b\_1)}}\label{number-of-bins-along-the-x-axis-b_1}}
...
\hypertarget{number-of-bins-along-the-y-axis-b_2}{%
\subsubsection{\texorpdfstring{Number of bins along the y-axis (\(b_2\))}{Number of bins along the y-axis (b\_2)}}\label{number-of-bins-along-the-y-axis-b_2}}
...
\begin{figure}
\includegraphics[width=1\linewidth,height=1\textheight]{figures/workflow_all_centroids} \caption{Workflow of generating hexagonal bin centroids}\label{fig:gen-fullcentroids}
\end{figure}
...
#> Rows: 40
#> Columns: 2
#> $ x <dbl> -0.1732051, 0.1732051, 0.5196152, 0.8660254, 1.2124356, 0.0000000, 0~
#> $ y <dbl> -0.15, -0.15, -0.15, -0.15, -0.15, 0.15, 0.15, 0.15, 0.15, 0.15, 0.4~
\end{verbatim}
...
\begin{figure}
\includegraphics[width=1\linewidth,height=1\textheight]{figures/hex_coordinates_img} \caption{Hexagon coordinates}\label{fig:hex-coordinates}
\end{figure}

\begin{figure}
\includegraphics[width=1\linewidth,height=1\textheight]{figures/workflow_all_coordinates} \caption{Workflow of generating hexagon coordinates}\label{fig:gen-allcoordinates}
\end{figure}
...
#> Rows: 240
#> Columns: 6
#> $ c_x   <dbl> -0.1732051, -0.1732051, -0.1732051, -0.1732051, -0.1732051, -0.1~
#> $ c_y   <dbl> -0.15, -0.15, -0.15, -0.15, -0.15, -0.15, -0.15, -0.15, -0.15, -~
#> $ x     <dbl> 0.0000000, 0.0000000, -0.1732051, -0.3464102, -0.3464102, -0.173~
#> $ y     <dbl> -0.05040708, -0.24959292, -0.34918584, -0.24959292, -0.05040708,~
...
\tightlist
\item
  Compute standardized counts within each hexagon
\end{enumerate}
...
#> 1  0.1732051 -0.15     2  0.2352941
#> 2  0.0000000  0.15     6  0.5294118
#> 3  0.3464102  0.15     7  0.4117647
#> 4  0.1732051  0.45    12  0.1764706
#> 5  0.5196152  0.45    13  0.3529412
#> 6  0.6928203  0.75    18  0.7058824
#> 7  0.8660254  1.05    24  0.4705882
#> 8  0.6928203  1.35    28  0.2941176
#> 9  1.0392305  1.35    29  0.2352941
#> 10 0.8660254  1.65    34  1.0000000
\end{verbatim}
...
#> $ pred_hb_id  <int> 12, 18, 24, 2, 12, 34, 18, 18, 18, 34, 18, 12, 29, 6, 18, ~
\end{verbatim}
