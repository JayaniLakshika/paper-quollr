...
This paper presents the R package, \texttt{quollr}, which is useful for understanding how NLDR warps high-dimensional space and fits the data (\hyperref[fig-algo]{Figure 1}).

\begin{figure}[H]
\includegraphics[width=1\linewidth]{paper-quollr_files/figure-latex/unnamed-chunk-3-1} \caption{algorithm}\label{fig:unnamed-chunk-3}
\end{figure}
...
Our algorithm includes the following steps: (1) scaling the NLDR data, (2) computing configurations of a hexagon grid, (3) binning the data, (4) obtaining the centroids of each bin, (5) indicating neighboring bins with line segments that connect the centroids, and (6) lifting the model into high dimensions (\hyperref[fig-algo-steps]{Figure 2}). A detailed description of the algorithm can be found in \textbf{cite the methodology paper}.

\begin{figure}[H]
\includegraphics[width=1\linewidth]{paper-quollr_files/figure-latex/unnamed-chunk-5-1} \caption{Key steps for constructing the model on the UMAP layout: (a) NLDR data, (b) hexagon bins, (c) bin centroids, (d) triangulated centroids, and (e) lifting the model into high dimensions. The `Scurve` data is shown.}\label{fig:unnamed-chunk-5}
\end{figure}
...
\includegraphics[width=1\linewidth]{paper-quollr_files/figure-latex/unnamed-chunk-25-1}
...
\includegraphics[width=1\linewidth]{paper-quollr_files/figure-latex/unnamed-chunk-26-1}
