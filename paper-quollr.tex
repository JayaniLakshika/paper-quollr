...
This article is created using \CRANpkg{knitr} \citep{knitr} and \CRANpkg{rmarkdown} \citep{rmarkdown} in R with the \texttt{rjtools::rjournal\_article} template. These \texttt{R} packages were used for this work: \texttt{cli} \citep{gabor2025}, \texttt{dplyr}, \texttt{ggplot2}, \texttt{interp} (\textgreater= 1.1-6), \texttt{langevitour}, \texttt{proxy}, \texttt{stats}, \texttt{tibble}, \texttt{tidyselect}, \texttt{crosstalk}, \texttt{plotly}, \texttt{kableExtra}, \texttt{patchwork}, and \texttt{readr}.
