...
\begin{figure}
\includegraphics[width=1\linewidth,alt={NLDR representations with different methods and (hyper)parameter choices.}]{paper-quollr_files/figure-latex/fig-example-1} \end{figure}
